...
public class Equi {
    ...
    public Map<Integer, Nodo[]> columna0;
    public Comp[] columnas;

    private String listAlfa = "";

    private boolean compatible = true;
    private boolean completo = false;
    int z = 0;

    public Equi(AFD a1, AFD a2, String alfa) {
        this.m1 = a1;
        this.m2 = a2;
        this.alfabeto = alfa;
    }
    ...
    public void compararAutomatas(Nodo iM1, Nodo iM2) {
        Nodo[] aux = new Nodo[2];
        aux[0] = iM1;
        aux[1] = iM2;
    ...
    public boolean llenarFilaDeSimbolos(Nodo m1, Nodo m2) {
        ...
        for (String simbolo : this.alfabeto.split(",")) {
            ...
            if ((a.finall && b.finall) || (!a.finall && !b.finall)) {
                columnas[x] = new Comp(simbolo, a, b);
                x++;
            } else {
